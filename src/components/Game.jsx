...
const Game = ({ onItemCollected, onGameComplete, onGameOver, onServerTransferred, onDrunkChange, onHealthChange, onTimeUpdate, onMineCountChange, totalItems, isPaused }) => {
